...
import { Plus, Trash2, FolderSync, Loader2, CheckCircle2, AlertCircle, Sparkles, Send, Rss, RefreshCw, Clock, XCircle, RotateCcw, FolderOpen, ChevronUp, ExternalLink, KeyRound } from 'lucide-react';
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <ConfirmDialog
                ...
                onOpenChange={(open) => { if (!open) setDeleteLibId(null); }}
                title="Delete library"
                description="Remove this library and all its books from the index? Files on disk are not affected."
                confirmLabel="Delete"
                variant="destructive"
                onConfirm={() => {
                  if (deleteLibId !== null) {
                    deleteLibrary.mutate(deleteLibId);
                    setDeleteLibId(null);
                  }
                }}
              />
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="rounded-lg bg-muted p-3 text-xs space-y-1">
                ...
                <ol className="list-decimal list-inside space-y-1">
                  <li>
                    ...
                    <a href="https://www.amazon.com/hz/mycd/myx#/home/settings/pdoc" target="_blank" rel="noopener noreferrer" className="text-primary underline inline-flex items-center gap-0.5">
                  ...
                  <li>
                    Gmail: use{' '}
                    <a href="https://myaccount.google.com/apppasswords" target="_blank" rel="noopener noreferrer" className="text-primary underline inline-flex items-center gap-0.5">
                  ...
                  <li>
                    Outlook: use{' '}
                    <a href="https://account.microsoft.com/security" target="_blank" rel="noopener noreferrer" className="text-primary underline inline-flex items-center gap-0.5">
                      App Password <ExternalLink className="h-2.5 w-2.5" />
                    </a>
              ...
              <div className="space-y-3">
                ...
                <Input id="kindle-email" placeholder="Kindle email (e.g. yourname@kindle.com)" value={kindleEmail} onChange={(e) => setKindleEmail(e.target.value)} />
                <Separator />
